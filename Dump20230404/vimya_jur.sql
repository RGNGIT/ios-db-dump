...
CREATE TABLE `jur` (
  ...
  PRIMARY KEY (`Key`),
  KEY `Jur_Key` (`Jur_Key`),
  CONSTRAINT `jur_fk2` FOREIGN KEY (`Jur_Key`) REFERENCES `jur_type` (`Key`)
...
LOCK TABLES `jur` WRITE;
/*!40000 ALTER TABLE `jur` DISABLE KEYS */;
/*!40000 ALTER TABLE `jur` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-04-04 13:30:22
