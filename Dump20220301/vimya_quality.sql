...
CREATE TABLE `quality` (
  ...
  `Quality_Type_Key` int DEFAULT NULL,
  `Name` varchar(20) DEFAULT NULL,
  `ShName` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`Key`),
  KEY `quality_fk1` (`Quality_Type_Key`),
  CONSTRAINT `quality_fk1` FOREIGN KEY (`Quality_Type_Key`) REFERENCES `quality_type` (`Key`)
...
-- Dump completed on 2022-03-01 13:24:39
