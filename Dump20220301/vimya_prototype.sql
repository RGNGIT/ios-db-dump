...
CREATE TABLE `prototype` (
  `Res_Key` int DEFAULT NULL,
  `Component_Key` int DEFAULT NULL,
  `Generation_Date` datetime DEFAULT NULL,
  KEY `Res_Key` (`Res_Key`),
  KEY `prototype_fk1` (`Component_Key`),
  CONSTRAINT `prototype_fk1` FOREIGN KEY (`Component_Key`) REFERENCES `interface_component` (`Key`),
  CONSTRAINT `prototype_fk2` FOREIGN KEY (`Res_Key`) REFERENCES `user_quality_rank_res` (`Res_Key`)
...
-- Dump completed on 2022-03-01 13:24:37
